...
#        self.perfilnovoaluno = JanelaPerfil()
    ...
    def setupUi(self):
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 681, 551))
        ...
        self.label_4.setGeometry(QtCore.QRect(470, 150, 47, 21))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtGui.QLabel(self.groupBox)
        self.label_5.setGeometry(QtCore.QRect(20, 30, 201, 16))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtGui.QLabel(self.groupBox)
        self.label_6.setGeometry(QtCore.QRect(10, 190, 211, 16))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtGui.QLabel(self.groupBox)
        self.label_7.setGeometry(QtCore.QRect(10, 300, 421, 16))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtGui.QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(10, 360, 171, 20))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtGui.QLabel(self.groupBox)
        self.label_9.setGeometry(QtCore.QRect(10, 270, 141, 20))
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(530, 150, 113, 20))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_4 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_4.setGeometry(QtCore.QRect(80, 150, 361, 20))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.checkBox = QtGui.QCheckBox(self.groupBox)
        self.checkBox.setGeometry(QtCore.QRect(140, 190, 91, 17))
        self.checkBox.setObjectName("checkBox")
        self.checkBox_2 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_2.setGeometry(QtCore.QRect(140, 220, 121, 17))
        self.checkBox_2.setObjectName("checkBox_2")
        self.checkBox_3 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_3.setGeometry(QtCore.QRect(140, 250, 111, 17))
        self.checkBox_3.setObjectName("checkBox_3")
        self.checkBox_4 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_4.setGeometry(QtCore.QRect(510, 190, 91, 17))
        self.checkBox_4.setObjectName("checkBox_4")
        self.checkBox_5 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_5.setGeometry(QtCore.QRect(590, 250, 91, 17))
        self.checkBox_5.setObjectName("checkBox_5")
        self.checkBox_6 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_6.setGeometry(QtCore.QRect(260, 190, 91, 17))
        self.checkBox_6.setObjectName("checkBox_6")
        self.checkBox_7 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_7.setGeometry(QtCore.QRect(260, 220, 91, 17))
        self.checkBox_7.setObjectName("checkBox_7")
        self.checkBox_8 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_8.setGeometry(QtCore.QRect(510, 220, 91, 17))
        self.checkBox_8.setObjectName("checkBox_8")
        self.checkBox_9 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_9.setGeometry(QtCore.QRect(260, 250, 91, 17))
        self.checkBox_9.setObjectName("checkBox_9")
        self.checkBox_10 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_10.setGeometry(QtCore.QRect(510, 250, 91, 17))
        self.checkBox_10.setObjectName("checkBox_10")
        self.checkBox_11 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_11.setGeometry(QtCore.QRect(360, 190, 91, 17))
        self.checkBox_11.setObjectName("checkBox_11")
        self.checkBox_12 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_12.setGeometry(QtCore.QRect(360, 220, 141, 17))
        self.checkBox_12.setObjectName("checkBox_12")
        self.checkBox_13 = QtGui.QCheckBox(self.groupBox)
        self.checkBox_13.setGeometry(QtCore.QRect(360, 250, 131, 17))
        self.checkBox_13.setObjectName("checkBox_13")
        self.lineEdit_5 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_5.setGeometry(QtCore.QRect(10, 330, 631, 20))
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.lineEdit_6 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_6.setGeometry(QtCore.QRect(180, 360, 113, 20))
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.label_10 = QtGui.QLabel(self.groupBox)
        self.label_10.setGeometry(QtCore.QRect(350, 360, 181, 20))
        self.label_10.setObjectName("label_10")
        self.lineEdit_7 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_7.setGeometry(QtCore.QRect(530, 360, 113, 20))
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.label_11 = QtGui.QLabel(self.groupBox)
        self.label_11.setGeometry(QtCore.QRect(10, 390, 431, 20))
        self.label_11.setObjectName("label_11")
        self.lineEdit_8 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_8.setGeometry(QtCore.QRect(10, 420, 631, 21))
        ...
        self.lineEdit_12.setGeometry(QtCore.QRect(140, 110, 111, 20))
        self.lineEdit_12.setObjectName("lineEdit_12")
        self.label_17 = QtGui.QLabel(self.groupBox)
        self.label_17.setGeometry(QtCore.QRect(280, 110, 41, 16))
        self.label_17.setObjectName("label_17")
        self.lineEdit_13 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_13.setGeometry(QtCore.QRect(320, 110, 321, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Email (Insper):"))
        ...
        self.label_16.setText(_translate("Dialog", "Aniversário(dd/mm):"))
        self.label_17.setText(_translate("Dialog", "Curso:"))
    ...
    def NovoUser(self):
        ...
        self.aniversario = self.lineEdit_12.text()
        self.curso = self.lineEdit_13.text()
        ...
        'facebook': self.facebook, 'snapchat': self.snapchat, 'instagram': self.instagram, 'adicional': self.add_information, 'entidade': "-", 'aniversario': self.aniversario, 'curso': self.curso})
